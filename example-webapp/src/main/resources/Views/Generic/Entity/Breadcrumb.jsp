...
<jsp:useBean id="entity" type="com.sdl.webapp.common.api.model.entity.8NavigationLinks" scope="request"/>
...
<%
    ...
    if (links != null && !links.isEmpty()) {
        ...
        %><ul class="breadcrumb" ${markup.entity(entity)}>
            <li><a href="<%= links.get(0).getUrl() %>"><%= links.get(0).getLinkText() %></a></li>
        <%
        if (start > 1) {
            %>
            <li>...</li>
