...
<div id="container" class="page-wrapper">
    ...
    <section class="tabs-main">
        <div class="container-fluid">
			<div class="row">
				<div class="col-sm-12">
				<!-- tabsMain will conditionally  come here (for home and inside pages) -->
					<div class="row">
						<div class="col-sm-12 rate-pane">
							<!-- formSearchBrand will come here (for home and inside pages) -->
							<!-- recent user comments will come here-->
							<!-- category carousal --> 
							<!-- div for rateOverlay -->
