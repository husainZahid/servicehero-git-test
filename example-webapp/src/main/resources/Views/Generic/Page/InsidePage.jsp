...
<div id="container" class="page-wrapper">
    <div class="page-container page-article">
		<!-- header (banner and hello guest section conditionaly comes here  -->
		<tri:region name="Hero"/>
		<section class="tabs-main">
			<tri:page name="Banner With Tabs" viewName="Shared/BannerWithTabs"/>
		</section>
		<section class="article">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
					   <tri:page name="Bread Crumbs"/>
					</div>
				</div>
				<div class="row check-this" >
					<tri:regions exclude="Hero,ArticleRight"/>
					<tri:region name="ArticleRight"/>
				</div>
			</div>
		</section>
